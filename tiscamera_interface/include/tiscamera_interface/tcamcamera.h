...
public:
    ...
    virtual bool get(TcamCamera &cam, int &value) {(void)cam;(void) value; return false;}
    virtual bool get(TcamCamera &cam, double &value) {(void)cam; (void) value; return false;}
    virtual bool get(TcamCamera &cam, std::string &value) {(void)cam; (void) value; return false;}
    virtual bool set(TcamCamera &cam, int value)  {(void)cam; (void) value; return false;}
    virtual bool set(TcamCamera &cam, double value) {(void)cam; (void) value; return false;}
    virtual bool set(TcamCamera &cam, std::string value) {(void)cam; (void) value; return false;}
};
